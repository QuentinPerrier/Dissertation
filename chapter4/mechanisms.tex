...
Our aim is thus to understand the economic mechanisms of job creation due to investment shifts. Why would divesting from fossil fuels and favouring sectors for a low-carbon future, such as renewable energies or building insulation, create jobs? Do the arguments of local jobs, domestic sources of energy and labour-intensive technologies hold in a general equilibrium?
...
However, the originality of our paper is twofold. 
...
%Finally, their simplifying assumptions can be considered a sufficient approximation considering the lack of accurate data. Indeed, there is often no data directly available on the cost structure of renewable energies. \citet{Cameron2015} showed the significant uncertainty in quoted figures, and the lack of first-hand figures, resulting in recursive referencing in the literature.
%To overcome this lack of data,the use of industry surveys has seldom been employed \citep{Lehr2008, Lehr2012}. But more commonly, researchers have resorted to chain-value approaches. They use data on cost structure and allocate these costs to the corresponding sectors in national accounts. This approach has recently been formalised by \citet{Garrett2017}, in a methodology he coined the "synthetic industry approach". This is the framework we will consider in the paper to estimate the investment required in the solar and building sectors.
...
\begin{table*}[!h]
	...
	\begin{minipage}{.3\textwidth}
		\centering
		\caption{Open economy with a fixed exchange rate $\epsilon$ and fixed exports}
...
We have then tested to what extent these conclusions stand in a CGE framework. 
